...
using WebApplication1.communityConversation.community;

namespace WebApplication1.communityConversation.communitySquare
{
    /// <summary>
    /// 获取指定用户的所有社区的所有动态并封装成json发送至前端
    /// 
    /// getUserCommunityInfo 的摘要说明
    /// </summary>
    public class getUserCommunityInfo : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
           ...
           // string userEmail = context.Request.QueryString["userEmail"].ToString();
            ...
            if (userEmail != null || userEmail != "")
            {
                ...
                OracleCommand myCommand = new OracleCommand("communityOperation.getUserCommunitiseContents", myConnection);
